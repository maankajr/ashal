...
import { handleMulterUpload, productImagesUpload } from "../middleware/upload.js";
...
router.post(
  "/products/:id/images",
  handleMulterUpload(productImagesUpload),
  vendorProductController.uploadProductImages
);
